...
public class FuncionariosDAO extends AbstractDAO {
    ...
    public Object list(int codigo) {
        session.beginTransaction();
        Criteria criteria = session.createCriteria(GldFuncionarios.class);
        criteria.add(Restrictions.eq("gldIdFuncionario", codigo));
    ...
    public Object listCpf(String cpf) {
        session.beginTransaction();
        Criteria criteria = session.createCriteria(GldFuncionarios.class);
         criteria.add(Restrictions.like("gldCpf", cpf + "%"));
        List lista = criteria.list();
        session.getTransaction().commit();        
        return lista;
    }
